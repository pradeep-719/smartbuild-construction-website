...
<head>
  ...
  <title>SmartBuild | Contractor Login & Register</title>
...
<body>
  <div class="container">
    ...
    <div class="form-side">
      ...
      <!-- LOGIN FORM -->
      <form id="loginForm" class="form active" action="consub.php" method="POST">
        <h2>Contractor Login</h2>
        <input type="email" name="Email" placeholder="Enter Email" required>
        <input type="password" name="Password" placeholder="Enter Password" required>
        <button type="submit" name="submit">Login</button>
        <p><a href="conpassword.php">Forgot Password?</a></p>
      ...
      <form id="registerForm" class="form" action="reg.php" method="POST">
        ...
        <div class="scrollable">
          ...
          <input type="text" name="Purpose" placeholder="Work Type (e.g. Masonry, Electrical)" required>
