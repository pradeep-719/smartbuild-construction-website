...
if (isset($_POST['send_otp'])) {
    ...
    if ($check->num_rows == 0) {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'SmartBuild Contractor';
...
<title>Contractor | Password Reset</title>
...
<body>
  ...
  <div class="container">
    <h2>🔐 Contractor Password Reset</h2>
    ...
    <p><a href="registr.php">⬅ Back to Login</a></p>
  </div>
