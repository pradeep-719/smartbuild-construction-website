...
$sql = "SELECT * FROM contractor ORDER BY id DESC";
...
<title>SmartBuild | Contractors</title>
...
<div class="sidebar">
  ...
  <a href="adform.php" class="active"><i class='bx bx-group'></i> Contractors</a>
    ...
    <table id="data-table">
      ...
      <?php while ($row = $result->fetch_assoc()) { ?>
        <tr>
          ...
          <td><?= htmlspecialchars($row['ExperienceYears'] ?? 'N/A') ?></td>
          <td>
            <?php if (!empty($row['ExperienceProof'])): ?>
              <img src="<?= htmlspecialchars($row['ExperienceProof']) ?>" width="60" height="40" onclick="zoomImage(this)">
            <?php else: ?>N/A<?php endif; ?>
          </td>
          <td>
            <?php if (!empty($row['AadharProof'])): ?>
              <a href="<?= htmlspecialchars($row['AadharProof']) ?>" class="view-link" target="_blank">View</a>
            <?php else: ?>N/A<?php endif; ?>
          </td>
          <td>
            <?php if (!empty($row['PanProof'])): ?>
              <a href="<?= htmlspecialchars($row['PanProof']) ?>" class="view-link" target="_blank">View</a>
            <?php else: ?>N/A<?php endif; ?>
          </td>
